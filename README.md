...
**היה בשירות צבאי סדיר החודש** — אם מסומן, מבטל את הכול לגמרי: הסכום הסופי הוא 0, כולל בונוס/הסדר מיוחד/התאמה ידנית גם אם מולאו.

**מילואים** — אם מסומן, מחליף את חישוב הנוכחות+התוספות בסכום קבוע של 500 ₪, אבל בונוס/הסדר מיוחד/התאמה ידנית עדיין מתווספים מעליו אם מולאו.

**הסדר מיוחד / בונוס / התאמה ידנית** — שלושה שדות סכום עצמאיים שמתווספים תמיד מעל הבסיס (נוכחות+תוספות, או 500 ₪ אם מילואים) — פרט אם סומן "שירות צבאי סדיר". רק ההתאמה הידנית יכולה להיות שלילית (להפחתה); הסדר מיוחד ובונוס מיועדים לתוספת בלבד.
