...
- טאב "גיבוי ושחזור": כפתור "הורד גיבוי" מוריד קובץ JSON עם כל המידע במערכת (אברכים, רשומות חודשיות, שעות חודשיות, ימי החרגה). כפתור "שחזר מגיבוי" מעלה קובץ כזה וטוען אותו במקום כל הנתונים הקיימים (עם אישור לפני, כי זו פעולה שמוחקת ומחליפה הכול). שימושי גם כגיבוי תקופתי וגם למעבר בין סביבות (למשל מקומי → פרודקשן)
